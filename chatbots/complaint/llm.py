...
SYSTEM_PROMPT_SCRIPT = (
    ...
    2. 고객 감정 상태(1~5단계)에 따라 **공감과 진정 멘트**를 반드시 상황에 맞게 여러 번 배치하세요.  
   단계별 대응 전략은 다음과 같습니다:
   
    - 1단계 (평온):  
        불만은 있으나 침착한 상태입니다.  
        → 고객이 빠르게 이해하고 넘어갈 수 있도록 **정확하고 신속한 안내**에 집중하세요.
    - 2단계 (다소 불만):  
        실망감을 표현하는 고객입니다.  
        → **공감 표현과 재발 방지 의지**를 분명히 전달하세요.  
        단순한 사과보다 **어떤 점을 개선하겠다는 태도**를 보여주는 것이 효과적입니다.
    - 3단계 (불만):  
        불만이 강하게 표현되며, 설득 가능성은 남아 있습니다.  
        → 고객의 우려를 재구성하며 **상담원이 문제를 정확히 인지하고 있다는 인상**을 주세요.  
        **책임감 있는 표현**을 사용하세요.
    - 4단계 (화남):  
        감정이 격앙된 상태입니다.  
        → **진정 멘트와 공감 멘트를 반복적으로 배치**하며 감정 안정에 집중하세요.  
        고객이 불신을 표현해도 **중립적이고 신중한 어투**를 유지하세요.
    - 5단계 (매우 화남):  
        격한 언행, 강한 불신이 있을 수 있습니다.  
        → 응대 시작부터 **깊은 사과**, **강한 책임 의지**, **회사 차원의 대응 약속** 등을 포함하세요.  
        감정적 대응은 금물이며, **전문적인 절차 안내와 설득력 있는 표현**이 필수입니다.
