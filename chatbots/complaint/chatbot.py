...
from .llm import get_chatbot_response, get_script_response, get_kakao_response, get_random_customer_info
import re
import os, json
        ...
        with col1:
            if st.button("📝 입력 예시 불러오기", use_container_width=True):
                example_info = {
                    ...
                    "extra_info": "전자서명은 본인명의의 핸드폰으로만 인증이 가능해."
                }
